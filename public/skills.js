...
import { firebaseConfig } from "./firebase-config.js";
    ...
    function getSkillIcon(name) {
      const map = {
        ...
        'scikitlearn': 'devicon-scikitlearn-original colored',
        ...
        'web3': 'devicon-web3js-plain colored',
        ...
        'indesign': 'devicon-indesign-plain colored',
        'xd': 'devicon-xd-plain colored',
        'invision': 'devicon-invision-original colored'
      };
      const key = name.toLowerCase().trim();
      if (map[key]) {
        return `<i class="${map[key]}"></i>`;
      }
      ...
      filtered.forEach((skill, i) => {
        ...
        card.innerHTML = `
          <div class="skill-card-top">
            <div class="skill-avatar">${getSkillIcon(skill.name)}</div>
